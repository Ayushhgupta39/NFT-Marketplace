      ...
      <div className="">
        <nav className="w-screen">
          ...
          <li className='flex items-center ml-5 pb-2'>
            ...
            <div className='inline-block font-bold text-base ml-2'>
              NFT Marketplace
            </div>
            </Link>
          </li>
          <li className='w-2/6'>
            <ul className='lg:flex justify-between items-center gap-x-4 font-bold mr-10 text-base'>
              {location.pathname === "/" ? 
              <li className='border-b-2 hover:pb-0 p-1'>
                <Link to="/">Marketplace</Link>
              </li>
              :
              <li className='hover:border-b-2 hover:pb-0 p-1'>
                <Link to="/">Marketplace</Link>
              </li>              
              }
